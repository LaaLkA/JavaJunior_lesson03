...
public class ToDoListApp {
    ...
    public static void addNewTask(Scanner scanner, List<ToDo> tasks) {
        System.out.println("Введите название нвоой задачи:");
        ...
        System.out.println("Новая задачиа добавлена!");
    }
    ...
    public static void markTaskAsDone(Scanner scanner, List<ToDo> tasks) {
        ...
        try {
            ...
            if (taskNumber > 0 || taskNumber <= tasks.size()) {
                ...
                saveTasksToFile(FILE_BIN, tasks);
                saveTasksToFile(FILE_XML, tasks);
                System.out.println("Задача отмечена как выполенная!");
            } else {
                System.out.println("Некоректный номер задачи. Попробуйте снова!");
            }
